...
const DashboardPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const fetchUpdates = () => {
      ...
      apiService.get<GameInvitation[]>(`/games/invitations/${userId}`)
        .then((data) => {
          const pending = data.filter((invitation) =>
  ...
  const handleInvitation = async (
    ...
    const updatedPendingInvitations = pendingInvitations.filter((invitation) =>
    ...
    try {
      ...
      setPendingInvitations([
        ...
        pendingInvitations.find((invitation) =>
          invitation.id === invitationId
        )!,
      ]);
    }
    ...
    <div className="dashboard-page">
      ...
      <div className="dashboard-container">
              ...
              {friends.map((friend) => (
                <li key={friend.username} className="friend-item">
                  ...
                  <img
                    ...
                    className="play-icon"
                    onClick={() =>
                      handlePlayWithFriend(friend.username)}
        ...
        <div className="dashboard-section">
          ...
          <button className="create-game-button" onClick={createGamestate}>
            Create Game
          </button>
        </div>
        <div className="dashboard-section">
                      ...
                      <li key={invitation.id} className="invitations-row">
                        ...
                        <div className="modal-buttons">
                          <button
                            ...
                            onClick={() =>
                              handleInvitation(invitation.id, "play")}
                          >
                            Play
                          </button>
                          <button
                            ...
                            onClick={() =>
                              handleInvitation(invitation.id, "decline")}
                          >
                            Decline
                          </button>
                        </div>
